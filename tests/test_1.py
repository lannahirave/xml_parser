...
['Відомість студентів', 'Відомість з відмітками', 'Електронний', 'Фінальна версія', ['Кіріл Шевчук', 'Антон Работніков', 'Максим Гнідченко'], 'Для викладачів', '110'],\
...
class Tests(unittest.TestCase):
    def test_sax(self):
        ...
        for i in range(len(answer)):
            self.assertEqual(answer[i].info(), answers[i])
